...
#실습 2-20--------------------------모르겠음 gpt님께서 가르쳐준대로 함 + if문으로 하는법
...
#실습 2-21-----------------모르겠음 위의 case when ~~~ end를 활용함
...
select * from `bank_account` a, `bank_customer` c where a.a_c_no = c.c_no;
...
join `bank_account` as t on t_a_no = a_no
